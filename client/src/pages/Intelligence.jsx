...
const Intelligence = () => {
  return (
    <div className="relative z-10 max-w-7xl mx-auto px-8 pt-40 pb-20">
      ...
      >
        {/* Visual Decoration */}
        <div className="absolute top-[-10%] right-[-5%] w-[400px] h-[400px] bg-blue-500/5 rounded-full blur-[100px] animate-pulse"></div>
        ...
        <div className="relative z-10 grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative aspect-square">
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <div className="absolute w-[80%] h-[80%] border-2 border-blue-500/10 rounded-full animate-spin-slow" style={{ animationDirection: 'reverse' }}></div>
              <div className="absolute w-[60%] h-[60%] border-2 border-purple-500/10 rounded-full animate-spin-slow"></div>
